INSERT INTO carsharing.addresses (id, country, city, street, house_number, deleted)
VALUES (1, 'adminland', 'admincity', 'adminstreet', 1, 0),
       (2, 'testcountry', 'testcity', 'teststreet', 9, 0),
       (3, 'Belarus', 'Grodno', 'Vrublevskogo', 1, 0),
       (4, 'Belarus', 'Grodno', 'Dombrovskogo', 20, 0),
       (5, 'Belarus', 'Minsk', 'Sovetskaya', 2, 0),
...
VALUES (1, 'ROLE_USER'),
       (2, 'ROLE_ADMIN');
INSERT INTO carsharing.users (id, username, password, email, is_active, passport_data_id, deleted)
