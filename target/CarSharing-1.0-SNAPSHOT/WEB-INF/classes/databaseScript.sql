...
INSERT INTO `carimage` VALUES (1,'/resources/imgs/audiR8_1.jpg',2),(2,'/resources/imgs/audiR8_2.jpg',2),(3,'/resources/imgs/audiR8_3.jpg',2),(4,'/resources/imgs/hondaCivic',1),(5,'/resources/imgs/hondaCivic',1);
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `fk_user_passportdata1` FOREIGN KEY (`passportdata_idPassportData`) REFERENCES `passportdata` (`idpassportdata`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `user` VALUES (1,'admin','admin','admin@mail.ru',1,1,2),(2,'testuser1','qwerty','test@mail.ru',1,2,1),(3,'testuser2','qwerty','test1@mail.ru',1,3,1);
