...
VALUES (1, 'ROLE_USER'),
       (2, 'ROLE_ADMIN');
INSERT INTO carsharing.users (idUser, username, password, email, is_active, passport_data_id, role_id, deleted)
VALUES (1, 'admin', '$2a$11$MJtj2BFcyPyJJUMO0fYjoeGF1RgaD1uBTCSYyIDkfRrFVIjX329b2', 'admin@mail.ru', 1, 1, 2, 0),
       (2, 'testuser1', '$2a$11$X322vbhLNKHzwrl12g8csuhGeM6/AW/LNgWt.XjImA3iuwIN3us0K', 'test@mail.ru', 1, 2, 1, 0),
       (3, 'testuser2', '$2a$11$BDG.Bo/VKwrT38AsZdL3Zu4pNhAgnO7BSVQq6ppBwiNWYdKIfvVWy', 'test1@mail.ru', 1, 3, 1, 0);
