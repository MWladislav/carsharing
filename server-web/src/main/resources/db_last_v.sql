...
(
    ...
    CONSTRAINT `fk_carImage_to_carProfile` FOREIGN KEY (`car_profile_id`) REFERENCES car_profiles (`id_car_profile`) ON DELETE NO ACTION ON UPDATE NO ACTION
)
    charset = utf8;
...
(
    ...
    CONSTRAINT `fk_car_to_carProfile` FOREIGN KEY (`car_profile_id`) REFERENCES car_profiles (`id_car_profile`) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
(
    ...
    `deleted`               tinyint(1) default 0 null,
     ...
     CONSTRAINT `fk_passportData_to_address` FOREIGN KEY (`address_id`) REFERENCES addresses (`idAddress`) ON DELETE NO ACTION ON UPDATE NO ACTION
)
    charset = utf8;
...
(
    ...
    CONSTRAINT `fk_user_to_passportData` FOREIGN KEY (`passport_data_id`) REFERENCES passport_data (`idPassportData`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `fk_user_to_role` FOREIGN KEY (`role_id`) REFERENCES roles (`idRole`) ON DELETE NO ACTION ON UPDATE NO ACTION
)
    charset = utf8;
...
(
    ...
    CONSTRAINT `fk_order_to_car` FOREIGN KEY (`car_id`) REFERENCES cars (`idCar`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `fk_order_to_user` FOREIGN KEY (`user_id`) REFERENCES users (`idUser`) ON DELETE NO ACTION ON UPDATE NO ACTION
)
    charset = utf8;
...
(
    ...
    CONSTRAINT `fk_orderAdditionalInfo_to_order` FOREIGN KEY (`order_id`) REFERENCES orders (`idOrder`) ON DELETE NO ACTION ON UPDATE NO ACTION
)
    charset = utf8;
